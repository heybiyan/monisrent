...
export function ProductThumbnail({ item, isSelected = false, onSelect }: ProductThumbnailProps) {
  ...
  return (
    <div
      ...
      className={clsx(
        ...
        isSelected
          ? "border-accent-dark ring-2 ring-accent-dark/10 shadow-md"
    ...
    >
      ...
      <div className="relative w-full h-28 my-2 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-center p-2 overflow-hidden group-hover:scale-[1.02] transition-transform">
        <div className="w-16 h-16 rounded-lg bg-gradient-to-tr from-slate-200 to-slate-100 border border-slate-300/60 flex items-center justify-center text-slate-400 font-bold text-xs shadow-inner">
